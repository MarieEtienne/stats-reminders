...
As we could expect on this kind of data, the estimated parameters are almost the same with the two methods, it is thus complicated to observe any difference in the estimated trends we show on the following graph.
