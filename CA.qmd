...
A Correspondence Analysis (CA), or "Analyse Factorielle de Correspondance" (AFC) in French, is a multivariate statistical method used to measure the distance between different profiles in your data or how different the data is to the independence hypothesis. The values can be quantitative, qualitative or semi-qualitative.
...
Just like in the PCA, we will be looking the orthogonal axis that maximizes the inertia. The parameter used is the chi 2 distance. The AFC gives a weight to each profile, proportional to the abundance of the profile.
