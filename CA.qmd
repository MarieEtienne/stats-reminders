...
#s.label(CA, xax = 3, yax= 4, boxes=FALSE)

>>>>>>> 5a38aba (Did a CA without the bassin that had a lot of weight)
```
...
#s.distri(CA_ade4_sansbassin$li,macroinv_red[,esp],cell=1.5,sub=macroinv_red[1,esp],csub=2)
#non equal row numbers, à voir pourquoi
```
