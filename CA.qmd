...
The inertia can be explained as the amount of information explained by the axis. Here we only show the first ten axes. We can see that the first axis explains more inertia when we remove the bassin, 16.75% versus 14.56% (@tbl-CA_interiabyaxis).
