...
In this study, two streams (the Rieu Querelle and the Verdanson), permanent ponds and an artificial water source (the retention basin) were sampled and the individuals identified. Each wetland was sampled at several randomly selected points, and three passes were made at each point.
...
```{r}
#Contribution of each individual and site to the CA
CA$col$contrib
CA$row
```
