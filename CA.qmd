...
In this study, the standardised I2M2 protocol of the Water Framework Directive (in french, *Directive Cadre sur l'Eau*) was adapted to a context of ponds and very shallow watercourses.
...
ggplot(data = CA_ade4_sansbassin_ligne_ZH) +
  ...
  labs(fill = "**Wetland**") + 
  ggtitle("**Abundance of individuals per macroinvertebrate order for each sample per wetland**", 
          subtitle = "Without Bassin samples") +
  xlab("**CA Axis 1**") + 
  ylab("**CA Axis 2**") +
  theme_bw() + 
  theme(axis.text.x = element_markdown(vjust = 1, hjust = 1, size = 11), 
