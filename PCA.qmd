...
The PCA methodology begins by **standardizing the data** (center and scale variables), then computing the **covariance or** **correlation matrix** to show how the variables vary together. Through eigenvalue decomposition, PCA identifies orthogonal directions in the data space—the principal components—ordered by the amount of variance they explain, with the first component capturing the maximum variance, the second capturing the next highest variance while being uncorrelated with the first, and so on.
...
Description of the quantitative variables : - rAME : relative Anterior Median Eyes - rALE : relative Anterior Lateral Eyes - rPME : relative Posterior Median Eyes - rPLE : relative Posterior Lateral Eyes
