...
Note : The concepts covered in this reminder sheet are taken from our Master's lectures and tutorials, written by @Y_Outreman and taught by @A_Masson .
:::
...
::: {#GLMMsBACK}
The resulting model, called Generalized Linear Mixed Model (GLMM) extends the GLM by adding these random effects alongside the fixed effects. Therefore, [GLMMs](#GLMMs) allow us to model both the relationship between predictors and responses and the non-independence among observations.
:::
...
# Cleveland plot
dotchart(dataBadger$N_setts,pch=16,col='olivedrab',xlab='Number of setts')
# Histogram
hist(dataBadger$N_setts,col='olivedrab',xlab="Number of setts",main="")
# Quantile-Quantile plot
qqnorm(dataBadger$N_setts,pch=16,col='olivedrab',xlab='')
qqline(dataBadger$N_setts,col='red')

# Number of buildings on farm
# Cleveland plot
dotchart(dataBadger$N_buildings,pch=16,col='olivedrab',xlab='Number of buildings')
# Histogram
hist(dataBadger$N_buildings,col='olivedrab',xlab="Number of buildings",main="")
# Quantile-Quantile plot
qqnorm(dataBadger$N_buildings,pch=16,col='olivedrab',xlab='')
qqline(dataBadger$N_buildings,col='red')

# Number of cattle housed in buildings on farm
# Cleveland plot
dotchart(dataBadger$N_cattle,pch=16,col='olivedrab',xlab='Number of cattle')
# Histogram
hist(dataBadger$N_cattle,col='olivedrab',xlab="Number of cattle",main="")
# Quantile-Quantile plot
qqnorm(dataBadger$N_cattle,pch=16,col='olivedrab',xlab='')
...
par(mfrow=c(1,3))
# Number of setts
plot(dataBadger$Activity~dataBadger$N_setts,pch=16,col='olivedrab',xlab='Number of setts',ylab='Presence of a sign of badger activity')

# Number of buildings
plot(dataBadger$Activity~dataBadger$N_buildings,pch=16,col='olivedrab',xlab='Number of buildings',ylab='Presence of a sign of badger activity')

# Number of cattle housed in buildings
plot(dataBadger$Activity~dataBadger$N_cattle,pch=16,col='olivedrab',xlab='Number of cattle',ylab='Presence of a sign of badger activity')

par(mfrow=c(2,5))
# Factor season
mosaicplot(dataBadger$Activity~dataBadger$season
           ,color=c('skyblue','red2')
...
### **5. Check for Colinearity Between Predictors (\$X\$s)**

To avoid multicolinearity issues during modeling, the relationships among predictor variables were examined. This step includes:
...
plot(dataBadger[7:9],pch=16,col='olivedrab')
...
hist(lrStat,xlim = c(0,40), col='olivedrab', main = "Histogram of the likelihood ratio statistic", xlab = "Likelihood ratio statistic") # Histogram of the 1000 values of likelihood of the simulated model
...
boxplot(diagZ, col='dodgerolivedrab4',ylab='#Rate of farms well-classified')
mean(diagZ)
```
