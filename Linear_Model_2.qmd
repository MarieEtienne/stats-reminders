...
# Cleveland plot
dotchart(dataBadger$N_setts,pch=16,col='olivedrab3',xlab='Number of setts')
# Histogram
hist(dataBadger$N_setts,col='olivedrab3',xlab="Number of setts",main="")
# Quantile-Quantile plot
qqnorm(dataBadger$N_setts,pch=16,col='olivedrab3',xlab='')
qqline(dataBadger$N_setts,col='red')

# Number of buildings on farm
# Cleveland plot
dotchart(dataBadger$N_buildings,pch=16,col='olivedrab3',xlab='Number of buildings')
# Histogram
hist(dataBadger$N_buildings,col='olivedrab3',xlab="Number of buildings",main="")
# Quantile-Quantile plot
qqnorm(dataBadger$N_buildings,pch=16,col='olivedrab3',xlab='')
qqline(dataBadger$N_buildings,col='red')

# Number of cattle housed in buildings on farm
# Cleveland plot
dotchart(dataBadger$N_cattle,pch=16,col='olivedrab3',xlab='Number of cattle')
# Histogram
hist(dataBadger$N_cattle,col='olivedrab3',xlab="Number of cattle",main="")
# Quantile-Quantile plot
qqnorm(dataBadger$N_cattle,pch=16,col='olivedrab3',xlab='')
...
plot(dataBadger[7:9],pch=16,col='olivedrab3')
...
hist(lrStat,xlim = c(0,40), col='olivedrab3', main = "Histogram of the likelihood ratio statistic", xlab = "Likelihood ratio statistic") # Histogram of the 1000 values of likelihood of the simulated model
