...
We present here, a reminder sheet on the General Linear Model (GLM) and its specific features. Its use will be illustrated through an example applied to ecological data on penguins from @Gorman2014.
