...
We present here, a reminder sheet on the **General Linear Model** **[(GLM)](#GLMback)** 
<span id="GLM"></span> 
and its specific features. Its use will be illustrated with an example applied to ecological data on penguins from @Gorman2014 .
...
The objective of the [GLM](#GLM) 
<span id="GLMback"></span> 
is to explain a dependent variable as a function of independent explanatory variables measured on statistical units from a sample of a population. This type of model is generally constructed as follows:
...
[ANCOVA](#ANCOVAback)
<span id="ANCOVA"></span> 
is used when we want to model the variable $Y$ as a function of several $X$ variables, which can be qualitative and quantitative.
